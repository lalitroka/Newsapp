...
List<User> users = <User>[
  User(
    assetImage: 'images/mountain.png',
    title: 'mina agarawal',
    bodytitle: ' she is the business man ',
    subtitle: 'viewd on 29 july 2024',
    smallImage: 'images/army.png',
    icons: 'Icons.ac_unit',
    description:
...
"''',
  ...
  User(
    ...
    title: 'mina Bista',
    bodytitle: ' she is the most beautifull girl in the world',
    subtitle: 'viewd on 21 july 2024',
    smallImage: 'images/army.png',
    icons: ' Icons.ac_unit',
    description:
...
The third little pig worked hard all day and built his house with bricks. It was a sturdy house complete with a fine fireplace and chimney. It looked like it could withstand the strongest winds.''',
  ...
  User(
    assetImage: 'images/mountain.png',
    title: 'Jason roy ',
    bodytitle: ' He is the father of manoj saud ',
    subtitle: 'viewd on 27 july 2024',
    smallImage: 'images/army.png',
    icons: 'Icons.ac_unit',
    description:
...
One day her mother said to her, "Come, Little Red Riding Hood, here is a piece of cake and a bottle of wine. Take them to your grandmother, she is ill and weak, and they will do her good. Set out before it gets hot, and when you are going, walk nicely and quietly and do not run off the path, or you may fall and break the bottle, and then your grandmother will get nothing. And when you go into her room, don't forget to say, good-morning, and don't peep into every corner before you do it."  ''',
  ...
  User(
      ...
      title: 'David son ',
      bodytitle: ' she is the business man ',
      subtitle: 'viewd on 25 july 2024',
      smallImage: 'images/army.png',
      icons: 'Icons.ac_unit',
      description:
...
There were other things in the stocking, nuts and oranges and a toy engine, and chocolate almonds and a clockwork mouse, but the Rabbit was quite the best of all. For at least two hours the Boy loved him, and then Aunts and Uncles came to dinner, and there was a great rustling of tissue paper and unwrapping of parcels, and in the excitement of looking at all the new presents the Velveteen Rabbit was forgotten. '''),
  User(
      ...
      title: 'mac sac',
      bodytitle: ' she is the business man ',
      subtitle: 'viewd on 26 july 2024',
      smallImage: 'images/army.png',
      icons: ' Icons.ac_unit ',
      description:
...
The next day, when Jack woke up in the morning and looked out of the window, he saw that a huge beanstalk had grown from his magic beans! He climbed up the beanstalk and reached a kingdom in the sky. There lived a giant and his wife. Jack went inside the house and found the giant’s wife in the kitchen. Jack said, “Could you please give me something to eat? I am so hungry!” The kind wife gave him bread and some milk. '''),
  User(
      ...
      title: ' Deactive man ',
      bodytitle: ' she is the business man ',
      subtitle: 'viewd on 24 july 2024',
      smallImage: 'images/army.png',
      icons: ' Icons.ac_unit',
      description:
  ...
  User(
      ...
      title: 'mina agarawal',
      bodytitle: ' she is the business man ',
      subtitle: 'viewd on 23 july 2024',
      smallImage: 'images/army.png',
      icons: 'Icons.ac_unit',
      description:
